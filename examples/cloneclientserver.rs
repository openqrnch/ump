...
// clones of the client, which is stupid because the client can just clone
// itself.  But this is used as an illustration to demonstrate that a server
// can return client clones of clients belonging to _different_ servers, which
// is less stupid.
